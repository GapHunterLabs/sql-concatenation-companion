package dev.gaphunter.sqlconcatenationcompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.sqlconcatenationcompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.sqlconcatenationcompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "SQL String Concatenation Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33678-sql-string-concatenation-companion/reviews"
